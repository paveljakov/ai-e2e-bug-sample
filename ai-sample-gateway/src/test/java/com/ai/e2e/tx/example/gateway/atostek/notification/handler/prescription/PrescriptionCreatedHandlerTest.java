...
public class PrescriptionCreatedHandlerTest {
  ...
  @InjectMocks
  private PrescriptionCreatedHandler prescriptionCreatedHandler;
  ...
  public void handle() {
    ...
    when(prescriptionService.create(eq(prescriptionWithMedication))).thenReturn(prescriptionWithMedicationMono);
    ...
    final NotificationResponseBuilder notificationResponseBuilder =
        prescriptionCreatedHandler.handle(notification, new NotificationResponseBuilder(LOG_PREFIX)).block();
